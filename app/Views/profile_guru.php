                ...
                <div class="card-body px-4 pb-4">
                    <form class="form-horizontal mt-3">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" value="<?= $session->nama_level ?>" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label">NIP</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" value="<?= $session->nip ?>" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Mata Pelajaran</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" value="<?= $session->nama_divisi ?>" readonly>
                            </div>
                        </div>
                    </form>
                </div>
