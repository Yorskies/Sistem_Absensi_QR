    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mt-3">
                    <p><strong>Nomor Induk:</strong> <?= htmlspecialchars($siswa->nomor_induk) ?></p>
                    <p><strong>Nama:</strong> <?= htmlspecialchars($siswa->nama) ?></p>
                    <p><strong>Kelas:</strong> <?= htmlspecialchars($siswa->kelas) ?></p>
                    <p><strong>Status:</strong> <?= htmlspecialchars($siswa->status) ?></p>
                    <p><strong>Username:</strong> <?= htmlspecialchars($siswa->username) ?></p>
                </div>
            </div>
